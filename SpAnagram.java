...
//        for (String word:betterWords.takeOrdered((int) betterWords.count())) {
//            if (word.length() < N) {
...
//        JavaPairRDD<String, Iterable<String>> anagrams = rdd.distinct().groupByKey();
//        JavaPairRDD<String, Iterable<String>> filteredData = anagrams.distinct().filter(new Function<Tuple2<String, Iterable<String>>, Boolean>() {
//            @Override
//            public Boolean call(Tuple2<String, Iterable<String>> v1) throws Exception {
//                int counter =0;
//                while (v1._2.iterator().hasNext()) {
//                    String str = v1._2.iterator().next();
//                    System.out.println("CALC ----- "+counter+" "+str);
//                    counter++;
//                    if(counter>1) {
//                        System.out.println("RET for Counter "+counter+" "+str);
//                        return true;
//                    }
//                }
//                return false;
